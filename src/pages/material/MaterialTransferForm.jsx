...
// Searchable Dropdown Component - Same as Intent PO
...
export default function MaterialTransferForm() {
  ...
  // Add new material row - Same as Intent PO
  ...
  // Update material - Same as Intent PO
  ...
  // Remove material row - Same as Intent PO
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-blue-50">
      ...
      <div className="max-w-md mx-auto min-h-screen bg-white shadow-xl">
        {/* Header with Gradient - Same as Intent PO */}
